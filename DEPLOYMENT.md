...
5. [Solana — Anchor Program](#solana--anchor-program)
6. [Bot — Fly.io](#bot--flyio)
...
2. Click **Register Video** → page loads, dropzone visible.
3. Upload `original.mp4` → fingerprint progress bar fills, title input appears.
4. Connect Phantom (Devnet) → wallet popup opens, approve.
5. Submit → Phantom signature popup → approve.
